...
var i;
var icon=document.querySelector(".icon-acc")
for (i = 0; i < acc.length; i++) {
  acc[i].addEventListener("click", function(e) {
    ...
    if (panel.style.height === "" || panel.style.height==="0px") {
      ...
      this.querySelector(".icon-acc").style.transform="rotateX(180deg)"
    } else {
        console.log(panel.style.height);
      panel.style.height = "0px";
      this.querySelector(".icon-acc").style.transform="rotateX(1800deg)"
